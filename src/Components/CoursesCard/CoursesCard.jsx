		...
		<>
			...
			>
				<div className="course_card_img">
					<img
						...
						style={{
							...
							height: "167px", // Fixes height to match the required size
							objectFit: "contain", // Ensures the image is cropped proportionally to fit
				...
				<div className="card_body">
					<div className="">
						<p className="text-light level-8 reg-font line-clamp-1 line-clamp mb-0">
							{label}{" "}
						</p>
					</div>
					<div className="">
						<h2 className="level-5-sm med-font text-uppercase line-clamp-2 line-clamp">
							{title}
						</h2>
					</div>
					<hr />
