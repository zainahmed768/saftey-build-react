...
const AboutUs = () => {
  ...
  console.log(courseReview, "aboutpageContent");
  return (
    <>
      <PrimaryHeader
            ...
            <Col xs={24} sm={24} md={8}>
              <Space direction="vertical" className="center_content_box">
                ...
                <p className="reg-font level-8">
                  ...
                  upon years of classroom training experience. SafetyBuilt is
                  the perfect choice for anyone who wants to prioritize safety
                  on construction sites. Our courses{" "}
                </p>
        ...
        <div className="py-5 site_width">
          <Row justify="space-between" align="middle">
            ...
            <Col xs={24} sm={24} md={4}>
              ...
              <p className="reg-font level-7 text-white text-capitalize">
                Safety Built offers high quality online
              </p>
            </Col>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <h1 className=" dark-color heading-font level-4  text-uppercase leter-1">
                We’re trusted by worldwide cutsomers
              </h1>
              ...
              <Col xs={24} sm={24} md={6}>
                <div className="resonance_card">
                  ...
                  <p className="med-font level-8  dark-color text-capitalize">
                    Safety Built offers high quality online training that’s
                    based upon years of{" "}
                  </p>
                </div>
              </Col>
            ...
            <Col xs={24} sm={24} md={17}>
              <div className="text-center">
                ...
                <p className="reg-font level-7  dark-color text-capitalize">
                  Safety Built offers high quality online training that’s based
                  upon years of classroom training experience. SafetyBuilt is
                  the perfect choice for anyone who wants to prioritize saf
                </p>
              </div>
            </Col>
          </Row>
